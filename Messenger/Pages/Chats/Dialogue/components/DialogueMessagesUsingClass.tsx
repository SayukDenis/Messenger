...
class DialogueMessagesUsingClass extends Component<DialogueMessagesProps & DialogueMessagesReduxProps> {
...
export default connect(mapStateToProps)(DialogueMessagesUsingClass);